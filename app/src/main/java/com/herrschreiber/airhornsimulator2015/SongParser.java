...
public class SongParser {
    ...
    private Song scale() {
        ...
        notes.add(new NoteInfo(0.5, 0.5, 293.66, 0.5));
        notes.add(new NoteInfo(1.0, 0.5, 329.63, 0.5));
        notes.add(new NoteInfo(1.5, 0.5, 349.23, 1.0));
        notes.add(new NoteInfo(2.0, 0.5, 392.00, 1.0));
        notes.add(new NoteInfo(2.5, 0.5, 440.00, 0.5));
        notes.add(new NoteInfo(3.0, 0.5, 493.88, 0.5));
        notes.add(new NoteInfo(3.5, 0.5, 523.25, 1.0));
